...
namespace ChristmasWithTypes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //TODO set Santa's name to Kris KringleX
            xmas.Santa = "Kris Kringle";

            //TODO Insert 3 presents you would like for xmas.  They must be stringsX
            xmas.Presents =  new string[3]{ "I have", "everything", "I want"}; 

            //TODO Set the TreeHeight to 10X
            xmas.TreeHeight = 10;
